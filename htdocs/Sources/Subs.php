		...
		*/
		...
		$codes = array(
			...
			array(
				...
				'content' => '<img class="posted-image" src="$1" alt="{alt}"{width}{height} border="0" />',
				'validate' => create_function('&$tag, &$data, $disabled', '
					$data = strtr($data, array(\'<br />\' => \'\'));
			...
			array(
				'tag' => 'img',
				'type' => 'unparsed_content',
				'content' => '<img class="posted-image" src="$1" alt="" border="0" />',
				'validate' => create_function('&$tag, &$data, $disabled', '
					$data = strtr($data, array(\'<br />\' => \'\'));
					if (strpos($data, \'http://\') !== 0 && strpos($data, \'https://\') !== 0)
						$data = \'http://\' . $data;
			...
			array(
				...
				'before' => '<div class="quoteheader">{author} said :</div><div class="quote">',
				'after' => '</div>',
				'block_level' => true,
			),
			array(
				'tag' => 'quote',
				'type' => 'parsed_equals',
				'before' => '<div class="quoteheader">$1 said :</div><div class="quote">',
				'after' => '</div>',
				'quoted' => 'optional',
				'block_level' => true,
			),
			array(
				...
				'before' => '<div class="quoteheader"><a href="' . $scripturl . '?{link}">{author} said on {date} : </a></div><div class="quote">',
				'after' => '</div>',
				'block_level' => true,
			),
			array(
